#to get the passwords copied into users clipboard you first have to install pyperclip module
#Now the user can also copy the code
import pyperclip
import random
import string
...
u9 = input("Do you want to copy the passwords/password(Y/N):").upper()
if u9 == "Y":
    pyperclip.copy("\n".join(lst))